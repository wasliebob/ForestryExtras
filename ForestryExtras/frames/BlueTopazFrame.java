...
public final class BlueTopazFrame extends Item implements IHiveFrame {

    public BlueTopazFrame(int id)
    {
        super(id);
        ...
        LanguageRegistry.addName(this, color + " " + name + " " + type);
    }
