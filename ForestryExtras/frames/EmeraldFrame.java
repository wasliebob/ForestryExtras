...
public final class EmeraldFrame extends Item implements IHiveFrame {

    public EmeraldFrame(int id)
    {
        super(id);
        ...
        decay = 1.0F;
        flowering = 1.5F;
        productionmodifier = 1.75F;
        lifespanmodifier = 1.7F;
        mutationmodifier = 1.2F;
        territorymodifier = 1.5F;      
